# -*- coding: utf-8 -*-
"""
Created on Mon Nov  1 22:41:44 2021

@author: ajaz7
"""
# -*- coding: utf-8 -*-
"""
Created on Sat Oct  9 09:50:34 2021
...
class Min_Heap:
    ...
    def bottom_up(self, heap, index):
        ...
        # if the current node is smaller than the parent node, swap them
    ...
    def top_down(self, heap, index):
        ...
        # Of the two children find the smaller one
...
# ################
# a = [1,12,3,4,25,6,10,100]
#myheap = Min_Heap([],'heapify')
